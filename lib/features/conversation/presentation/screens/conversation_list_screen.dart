...
class ConversationListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final currentUserEmail =
        'shahinbashar2@gmail.com'; // Replace with actual current user email
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Conversation>>(
        future:
            conversationRepository.getConversationsForUser(currentUserEmail),
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return Center(
                child: Text('Failed to load conversations: ${snapshot.error}'));
          }
